...
Note that [CBM_vol2biomass](https://github.com/PredictiveEcology/CBM_vol2biomass.git) is also study-area specific, as @boudewyn2007 parameters are dominant species and ecozone specific. 
...
The Carbon Budget Model (CBM) was first developed in the early 1990s (@kurz1993). Its implementation in a platform for model inter-operability and nimbleness such as [SpaDES](https://SpaDES.PredictiveEcology.org) warrants an overview. 
