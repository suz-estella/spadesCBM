...
The second module [CBM_dataPrep](https://github.com/PredictiveEcology/CBM_dataPrep_SK.git) is a data preparation SpaDES module, where input data and spatial layers are assembled and prepared for a specific study area. The example in this manual simulates the managed forest of Saskatchewan.
...
Note that [CBM_vol2biomass](https://github.com/PredictiveEcology/CBM_vol2biomass.git) is also study-area specific as @boudewyn2007 parameters are dominant species and ecozones specific.
These three modules provide the inputs to the [CBM_core](https://github.com/PredictiveEcology/CBM_core.git) module where processes are applied on a specified time step (in our example, yearly). 
...
Several core utilities to [spadesCBM](https://github.com/PredictiveEcology/spadesCBM.git) are provided by the [`CBMutils`](https://github.com/PredictiveEcology/CBMutils@development) package, available on GitHub. Active development in [`CBMutils`](https://github.com/PredictiveEcology/CBMutils@development) and all [spadesCBM](https://github.com/PredictiveEcology/spadesCBM.git) modules is underway.
